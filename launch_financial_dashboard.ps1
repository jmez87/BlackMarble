# BLACK MARBLE Financial Dashboard Launcher
...
Write-Host "  BLACK MARBLE Financial Dashboard" -ForegroundColor Cyan
Write-Host "  Real-time Financial Metrics & Analytics" -ForegroundColor Green
Write-Host "================================================================" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "[INFO] Launching Financial Dashboard..." -ForegroundColor Cyan
...
try {
    streamlit run scripts/black_marble_dashboard.py --server.headless false --server.port 8502
} catch {
    Write-Host ""
...
Write-Host ""
Write-Host "[SUCCESS] Dashboard stopped. Thanks for using BLACK MARBLE Financial Dashboard!" -ForegroundColor Green
Read-Host "Press Enter to exit"